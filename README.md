...
* Dark Mode, 
* отзывчивый 
* UI попытки удовлетворить браузеры, устройства и т.п.
* В какой-то момент меню меняется на бургер,
* флексбоксовские айтемы сжимаются, но не сжимают фотки.
* прогружает при прохождение до дна новые посты.
>Как работает? 
...
7. ~~Не все типы постов изучил и обработал. Надеюсь простите, там вряд ли много чего меняется.~~ (исправил немного)
